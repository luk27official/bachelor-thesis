...
\xxx{TODO: mention keywords: protein, ligand, binding site, pocket, docking, conservation, prediction, structure, residues, sequence, amino acids, nucleotid}
...
\xxx{TODO: maybe add examples of the data formats?}
